...
For non-nested models, one can adjust (option `adjusted=TRUE`) for the difference in the number of parameters in both models using the correction factor $p/2$ log $n$ - $q/2$ log $n$ (Vuong, 1989) which corresponds to the information criterion of Schwarz (1978), but with number of events instead of number of observations. 
