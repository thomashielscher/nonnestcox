...
For non-nested models, one can adjust (option `adjusted`) for the difference in the number of parameters in both models using the AIC or BIC correction factor (Vuong, 1989), but for BIC with number of events instead of number of observations. 
